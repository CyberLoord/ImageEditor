...
#include <memory>
#include "../ImageEditor2/camerawindow.h"
...
Q_CONSTINIT static const qt_meta_stringdata_cameraWindow_t qt_meta_stringdata_cameraWindow = {
    {
        ...
        QT_MOC_LITERAL(13, 15),  // "signalOpenImage"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 5),  // "image"
        QT_MOC_LITERAL(36, 23),  // "on_recordButton_clicked"
        QT_MOC_LITERAL(60, 10),  // "updateView"
        QT_MOC_LITERAL(71, 28),  // "on_applyFilterButton_clicked"
        QT_MOC_LITERAL(100, 28),  // "on_closeWindowButton_clicked"
        QT_MOC_LITERAL(129, 26)   // "on_openImageButton_clicked"
    },
    "cameraWindow",
    "signalOpenImage",
    "",
...
Q_CONSTINIT const QMetaObject cameraWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_cameraWindow_t,
        ...
        // method 'updateView'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_applyFilterButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_closeWindowButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void cameraWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalOpenImage((*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[1]))); break;
        case 1: _t->on_recordButton_clicked(); break;
        case 2: _t->updateView(); break;
        case 3: _t->on_applyFilterButton_clicked(); break;
        case 4: _t->on_closeWindowButton_clicked(); break;
        case 5: _t->on_openImageButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (cameraWindow::*)(QPixmap );
            if (_t _q_method = &cameraWindow::signalOpenImage; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void cameraWindow::signalOpenImage(QPixmap _t1)
{
